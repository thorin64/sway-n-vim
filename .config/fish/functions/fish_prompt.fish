...
function fish_prompt
  ...
  test $status -ne 0;
    and set -l last_status_colors 666 aaa e4d00a
    or set -l last_status_colors 666 aaa 008f11
  ...
  set -l color_pink   (set_color -o e4d00a)
  set -l color_yellow (set_color -o 00ff41)
  set -l color_green  (set_color -o 113311)
  set -l color_blue   (set_color -o 008f11)
  set -l color_purple (set_color -o 008f11)
  set -l color_dim    (set_color -o c0c0c0)
  set -l color_off    (set_color -o normal)
